    ...
    return (
        <div className="admin-container">
            ...
            <header className="admin-header">
                <div>
                    <h1 className="admin-title">Quản lý lớp học</h1>
                    <p className="admin-subtitle">Quản lý các lớp học, nhóm học tập trên hệ thống.</p>
                </div>
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                        ...
                                        <tr key={group.id}>
                                            ...
                                            <td>
                                                <div className="action-group">
                                                    <button className="text-btn" onClick={() => navigate(`/admin/class-groups/${group.id}`)}>Quản lý</button>
                                    ...
                                    {classGroups.length === 0 && (
                                        <tr>
                                            <td colSpan="6" className="empty-state">Không có lớp học nào.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
