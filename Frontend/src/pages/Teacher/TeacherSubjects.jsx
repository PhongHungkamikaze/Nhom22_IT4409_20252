            ...
            {isModalOpen && (
                <div className="modal-overlay" style={{
                    ...
                    <div className="modal-content" style={{
                        ...
                        <h2 style={{ marginBottom: '20px' }}>{isEdit ? 'Sửa môn học' : 'Thêm môn học'}</h2>
                        <form onSubmit={handleSave}>
                            <div className="form-group" style={{ marginBottom: '15px' }}>
                                <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Tên môn học *</label>
                                <input 
                                    type="text" 
                            ...
                            <div style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
                                ...
                                <button type="button" className="secondary-btn" style={{ border: '2px solid #e5e7eb', padding: '11px 20px', borderRadius: '12px' }} onClick={() => setIsModalOpen(false)}>Hủy</button>
                            </div>
                        </form>
                    </div>
                </div>
